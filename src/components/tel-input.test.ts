...
import VueTelInput from './tel-input.vue';
...
describe('tel-input', () => {
  ...
  it('renders without crash', () => {
    ...
    expect(wrapper.find('.tel-input').exists()).toBeTruthy();
  });
...
describe('Props', () => {
  ...
  describe(':disabled', () => {
    it('adds disabled class to component', () => {
      ...
      wrapper.vm.$nextTick(() => {
        expect(wrapper.find('.tel-input').classes()).toContain('disabled');
  ...
  describe(':styleClasses', () => {
    it('sets classes along side with .tel-input', () => {
      const wrapper = shallowMount(VueTelInput, {
        props: {
          styleClasses: ['test'],
        },
      ...
      wrapper.vm.$nextTick(() => {
        expect(wrapper.find('.tel-input').classes()).toContain('test');
      })
    });
  });
});
