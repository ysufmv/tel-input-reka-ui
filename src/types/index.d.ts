...
export interface TelInputProps {
    ...
    /**
     * Disable tel-input, including the input & flag dropdown
     * @default false
     */
    disabled?: boolean;
    /**
...
export interface TelInputEmits {
    /**
     * Fires when the input changes
     * In tel-input@next (Vue 3), this replaces the @input event
     */
    ...
    /**
     * Emits the E.164 formatted phone number whenever it changes
     */
    "update:number": (number: string | undefined) => void;
    [key: string]: (...args: any[]) => void;
}

declare const TelInput: DefineComponent<TelInputProps, {}, {}, {}, {}, {}, {}, TelInputEmits> & {
